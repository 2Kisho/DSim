...
public class UtilRes {
	...
	/**
	 * Retrieves the translation from the {@link ResourceBundle} wit the given key
	 * in the manner of:
	 * 
	 * <pre>
	 * ClazzName.key
	 * </pre>
	 * 
	 * @param clazz The {@link Class} thats name should be used.
	 * @param key   A {@link String} that indicates the key.
	 ...
	 * 
	 * @param key A String that determines which translation should be used.
	 * @return A String with the translation, if no key was found the key itself.
	 */
